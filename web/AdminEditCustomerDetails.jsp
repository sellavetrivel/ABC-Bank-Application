                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <form action="AdminEditCustomerDetails" method="post">
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            <tr><td>Bank</td><td><input type="text" name="bankname" class="form-control" value="<%=bankname%>"   required="" readonly=""></td></tr>
                                            ...
                                            <tr><td>E-mail</td><td><input type="text" name="mail" value="<%=mail%>" class="form-control"   required=""></td></tr>
                                            <tr><td>Gender</td><td><input type="text" name="gender" value="<%=gender%>" class="form-control"  required=""></td></tr>
                                            <tr><td>Age</td><td><input type="text" name="age" value="<%=age%>" class="form-control"   required=""></td></tr>
                                            <tr><td>Branch</td><td><input type="text" name="branchname" value="<%=branchname%>" class="form-control"   required=""></td></tr>
                                            <tr><td>Address</td><td><input type="text" name="address" value="<%=address%>" class="form-control"  required=""></td></tr>
                                            <tr><td>Account Number</td><td><input type="text" name="acno" value="<%=acno%>" class="form-control"  required="" readonly=""></td></tr>
                                            <tr><td>IFSC Code</td><td><input type="text" name="ifsc" value="<%=ifsc%>" class="form-control"  required=""></td></tr>
                                            <tr><td></td><td><input type="submit" value="Update" class="form-control btn btn-sm btn-primary"></td></tr>
